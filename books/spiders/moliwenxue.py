...
class moliwenxueSpider(scrapy.Spider):
    name = 'moliwenxue'
    allowed_domains = ['moliwenxue.com','www.xs.la']
    start_urls = [
					#['166','http://www.moliwenxue.com/book/760','//div[@id="list"]/dl/dd/a','//*[@id="content"]/text()'],
					['173','https://www.xs.la/152_152165/','//div[@id="list"]/dl/dd/a','//*[@id="content"]/text()'],
				]
